...
/// Phase 5b golden: bubble chart vs. ApexCharts v4.7.0.
///
/// Bubbles are solid-fill circles whose radius is derived from the per-point z
/// value (`Scatter.js` handles both scatter and bubble). Like the other
/// solid-fill goldens the tolerance is generous because anti-aliasing differs
/// along every circle edge between the SVG and Skia rasterizers.
void main() {
