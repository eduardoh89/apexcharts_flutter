...
/// Phase 6 golden: radialBar gauge vs. ApexCharts v4.7.0 (`Radial.js`).
///
/// Solid stroked arcs (track + value) plus centered labels — generous
/// tolerance for the anti-aliasing along the ring edges.
void main() {
  const tolerances = <String, double>{
    'radialbar_basic': 0.30,
  };
