...
/// Phase 6 golden: radar (spider) chart vs. ApexCharts v4.7.0 (`Radar.js`).
///
/// Polygon grid + filled series areas; tolerance is generous because of the
/// translucent fills and anti-aliased polygon edges.
void main() {
